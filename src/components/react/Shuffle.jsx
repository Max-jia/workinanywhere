    ...
    () => {
      ...
      const build = () => {
        ...
        chars.forEach(ch => {
          ...
          let startX = 0; let finalX = 0; let startY = 0; let finalY = 0;
      ...
      const play = () => {
        ...
        if (animationMode === 'evenodd') {
          ...
          const tweenVars = { duration, ease, force3D: true, stagger };
          if (isVertical) {
            if (odd.length) tl.to(odd, { y: (i, t) => parseFloat(t.getAttribute('data-final-y') || '0'), ...tweenVars }, 0);
            if (even.length) tl.to(even, { y: (i, t) => parseFloat(t.getAttribute('data-final-y') || '0'), ...tweenVars }, evenStart);
          } else {
            if (odd.length) tl.to(odd, { x: (i, t) => parseFloat(t.getAttribute('data-final-x') || '0'), ...tweenVars }, 0);
            if (even.length) tl.to(even, { x: (i, t) => parseFloat(t.getAttribute('data-final-x') || '0'), ...tweenVars }, evenStart);
          }
        } else {
